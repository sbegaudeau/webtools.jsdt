...
import org.eclipse.wst.jsdt.internal.core.jdom.SimpleDOMBuilder;
...
public DOMFactory() {
	...
	this.lineSeparator = org.eclipse.wst.jsdt.internal.core.util.Util.getLineSeparator(null, null/*take the workspace line separator as no project is available*/);
}
/* (non-Javadoc)
