...
public class TypeParameterReferenceMatch extends SearchMatch {
	 ...
	 */
	public TypeParameterReferenceMatch(IJavaScriptElement enclosingElement, int accuracy, int offset, int length, boolean insideDocComment, SearchParticipant participant, IResource resource) {
