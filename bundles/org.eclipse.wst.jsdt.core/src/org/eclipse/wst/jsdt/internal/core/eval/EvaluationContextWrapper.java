 ...
 *******************************************************************************/
package org.eclipse.wst.jsdt.internal.core.eval;
...
import org.eclipse.wst.jsdt.core.eval.IGlobalVariable;
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#allVariables()
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor)
 * @deprecated
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor, WorkingCopyOwner)
 * @deprecated
 */
public void codeComplete(String codeSnippet, int position, ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(codeSnippet, position, new org.eclipse.wst.jsdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor)
 */
public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor) throws JavaModelException {
	codeComplete(codeSnippet, position, requestor, DefaultWorkingCopyOwner.PRIMARY);
}
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner)
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#codeSelect(String, int, int)
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#codeSelect(String, int, int, WorkingCopyOwner)
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#deleteVariable(IGlobalVariable)
 */
...
public void evaluateCodeSnippet(
	...
	IProgressMonitor progressMonitor) throws org.eclipse.wst.jsdt.core.JavaModelException {
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#getImports()
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#getPackageName()
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#getProject()
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#newVariable(String, String, String)
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#setImports(String[])
 */
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext#setPackageName(String)
 */
