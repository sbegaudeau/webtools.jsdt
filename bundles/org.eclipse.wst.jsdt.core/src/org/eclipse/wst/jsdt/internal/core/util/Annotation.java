...
public class Annotation extends ClassFileStruct implements IAnnotation {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotation#getTypeIndex()
	 */
	public int getTypeIndex() {
		return this.typeIndex;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotation#getComponentsNumber()
	 */
	public int getComponentsNumber() {
		return this.componentsNumber;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotation#getComponents()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotation#getTypeName()
	 */
