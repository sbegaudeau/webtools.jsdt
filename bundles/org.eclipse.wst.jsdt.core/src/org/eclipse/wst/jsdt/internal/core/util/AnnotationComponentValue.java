...
import org.eclipse.wst.jsdt.core.util.IConstantPoolConstant;
...
public class AnnotationComponentValue extends ClassFileStruct implements IAnnotationComponentValue {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getAnnotationComponentValues()
	 */
	public IAnnotationComponentValue[] getAnnotationComponentValues() {
		return this.annotationComponentValues;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getAnnotationValue()
	 */
	public IAnnotation getAnnotationValue() {
		return this.annotationValue;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getClassInfo()
	 */
	public IConstantPoolEntry getClassInfo() {
		return this.classInfo;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getClassInfoIndex()
	 */
	public int getClassInfoIndex() {
		return this.classFileInfoIndex;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getConstantValue()
	 */
	public IConstantPoolEntry getConstantValue() {
		return this.constantValue;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getConstantValueIndex()
	 */
	public int getConstantValueIndex() {
		return this.constantValueIndex;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getEnumConstantName()
	 */
	public char[] getEnumConstantName() {
		return this.enumConstantName;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getEnumConstantNameIndex()
	 */
	public int getEnumConstantNameIndex() {
		return this.enumConstantNameIndex;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getEnumConstantTypeName()
	 */
	public char[] getEnumConstantTypeName() {
		return this.enumConstantTypeName;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getEnumConstantTypeNameIndex()
	 */
	public int getEnumConstantTypeNameIndex() {
		return enumConstantTypeNameIndex;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getTag()
	 */
	public int getTag() {
		return this.tag;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IAnnotationComponentValue#getValuesNumber()
	 */
