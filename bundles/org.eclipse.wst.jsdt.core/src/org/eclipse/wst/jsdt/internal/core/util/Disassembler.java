...
//	private static final char[] ANY_EXCEPTION = Messages.classfileformat_anyexceptionhandler.toCharArray();
	...
	/**
	 * @see #disassemble(org.eclipse.wst.jsdt.core.util.IClassFileReader, java.lang.String, int)
	 */
	...
	public String disassemble(IClassFileReader classFileReader, String lineSeparator, int mode) {
		if (classFileReader == null) return org.eclipse.wst.jsdt.internal.compiler.util.Util.EMPTY_STRING;
		...
		if (checkMode(mode, SYSTEM | DETAILED)) {
			...
			buffer.append(
				...
				new String[] {
					...
					+ (isDeprecated(classFileReader) ? ", deprecated" : org.eclipse.wst.jsdt.internal.compiler.util.Util.EMPTY_STRING)//$NON-NLS-1$
				}));
