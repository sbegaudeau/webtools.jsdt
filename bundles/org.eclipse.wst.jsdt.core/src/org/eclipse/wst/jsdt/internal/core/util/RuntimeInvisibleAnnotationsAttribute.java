...
public class RuntimeInvisibleAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeInvisibleAnnotations#getAnnotations()
	 */
	public IAnnotation[] getAnnotations() {
		return this.annotations;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeInvisibleAnnotations#getAnnotationsNumber()
	 */
