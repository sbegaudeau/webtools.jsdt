...
public class RuntimeInvisibleParameterAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeInvisibleParameterAnnotations#getAnnotations()
	 */
	public IParameterAnnotation[] getParameterAnnotations() {
		return this.parameterAnnotations;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeInvisibleParameterAnnotations#getParametersNumber()
	 */
