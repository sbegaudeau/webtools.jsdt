...
public class RuntimeVisibleAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeVisibleAnnotations#getAnnotations()
	 */
	public IAnnotation[] getAnnotations() {
		return this.annotations;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeVisibleAnnotations#getAnnotationsNumber()
	 */
