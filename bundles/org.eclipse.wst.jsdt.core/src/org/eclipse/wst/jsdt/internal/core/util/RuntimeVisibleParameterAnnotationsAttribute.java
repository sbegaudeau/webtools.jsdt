...
public class RuntimeVisibleParameterAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeVisibleParameterAnnotations#getAnnotations()
	 */
	public IParameterAnnotation[] getParameterAnnotations() {
		return this.parameterAnnotations;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.wst.jsdt.core.util.IRuntimeVisibleParameterAnnotations#getParametersNumber()
	 */
