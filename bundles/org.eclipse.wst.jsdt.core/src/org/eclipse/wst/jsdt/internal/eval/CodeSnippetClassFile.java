...
public CodeSnippetClassFile(
	org.eclipse.wst.jsdt.internal.compiler.lookup.SourceTypeBinding aType,
	org.eclipse.wst.jsdt.internal.compiler.ClassFile enclosingClassFile,
	 ...
	 *
	 * @param aType org.eclipse.wst.jsdt.internal.compiler.lookup.SourceTypeBinding
	 * @param enclosingClassFile org.eclipse.wst.jsdt.internal.compiler.codegen.ClassFile
	...
	if (this.enclosingClassFile == null) {
		this.codeStream.maxFieldCount = aType.classScope.referenceType().maxFieldCount;
	} else {
