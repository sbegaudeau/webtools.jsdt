 ...
 * @param kind int
 * @param parent org.eclipse.wst.jsdt.internal.compiler.lookup.Scope
 */
...
/**
 * CodeSnippetScope constructor comment.
 * @param parent org.eclipse.wst.jsdt.internal.compiler.lookup.BlockScope
 */
...
public FieldBinding findFieldForCodeSnippet(TypeBinding receiverType, char[] fieldName, InvocationSite invocationSite) {
	...
	if (interfacesToVisit != null) {
		...
		org.eclipse.wst.jsdt.internal.compiler.util.SimpleSet interfacesSeen = new org.eclipse.wst.jsdt.internal.compiler.util.SimpleSet(lastPosition * 2);
