...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext
 */
...
public EvaluationContext() {
	...
	this.lineSeparator = org.eclipse.wst.jsdt.internal.compiler.util.Util.LINE_SEPARATOR; // default value
}
/**
...
/**
 * @see org.eclipse.wst.jsdt.core.eval.IEvaluationContext
 * @exception org.eclipse.wst.jsdt.internal.eval.InstallException if the code snippet class files could not be deployed.
 */
...
writer.write(org.eclipse.wst.jsdt.internal.eval.EvaluationContext.getCodeSnippetSource());
writer.close();
org.eclipse.wst.jsdt.internal.compiler.batch.Main.compile(
	"d:/temp/CodeSnippet.js -d d:/temp -classpath d:/jdk1.2.2/jre/lib/rt.jar -verbose");
java.io.FileInputStream reader =  new java.io.FileInputStream("d:/temp/org/eclipse/jdt/internal/eval/target/CodeSnippet.class");
byte[] bytes = org.eclipse.wst.jsdt.internal.core.Util.readContentsAsBytes(reader);
reader.close();
...
public static String getCodeSnippetSource() {
	return
		"package org.eclipse.wst.jsdt.internal.eval.target;\n" + //$NON-NLS-1$
		"\n" + //$NON-NLS-1$
		"/*\n" + //$NON-NLS-1$
...
/**
 * Return the binary for the root code snippet class (ie. org.eclipse.wst.jsdt.internal.eval.target.CodeSnippet).
 */
 ...
 *
 *  @param environment org.eclipse.wst.jsdt.internal.core.SearchableEnvironment
 *      used to resolve type/package references and search for types/packages
 *      based on partial names.
 *
