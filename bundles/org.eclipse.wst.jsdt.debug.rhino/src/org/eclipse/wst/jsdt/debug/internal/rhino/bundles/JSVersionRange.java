...
public class JSVersionRange {
	...
	public JSVersionRange(String versionRange) {
		if (versionRange == null || versionRange.length() == 0) {
			...
			includeMin = true;
			maxVersion = JSVersionRange.versionMax;
			includeMax = true;
			return;
		}
	...
	public boolean isIncluded(Version version) {
		...
		if (version == null)
			return false;
		Version maxRequired = getMaximum() == null ? JSVersionRange.versionMax : getMaximum();
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + (maxVersion != null ? maxVersion.hashCode() : JSVersionRange.versionMax.hashCode());
	...
	public String toString() {
		...
		if (JSVersionRange.versionMax.equals(maxVersion))
