...
public class PacketReceiveManager extends PacketManager {
	...
	public Packet getCommand(String type, long timeToWait) throws TimeoutException, DisconnectedException {
		...
		if (isDisconnected()) {
			throw new DisconnectedException(Messages.runtime_disconnected, getDisconnectedException());
		}
		// Check for a timeout.
		throw new TimeoutException(NLS.bind(Messages.time_out_waiting_for_command_packet, new String[] {type}));
	}
