...
public final class SerialVersionComputationHelper {
	...
	private static final String LAUNCH_CONFIG_TYPE= "org.eclipse.wst.jsdt.ui.serial.support"; //$NON-NLS-1$

	/** The serial support class */
	private static final String SERIAL_SUPPORT_CLASS= "org.eclipse.wst.jsdt.internal.ui.text.correction.SerialVersionComputer"; //$NON-NLS-1$
