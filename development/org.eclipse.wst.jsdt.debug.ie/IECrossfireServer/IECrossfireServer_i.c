...
MIDL_DEFINE_GUID(IID, IID_IPendingScriptLoad,0x56C1AD62,0x3E69,0x46BA,0xBE,0x6D,0xE1,0xD2,0xA0,0xD8,0x8A,0xB5);
...
MIDL_DEFINE_GUID(CLSID, CLSID_PendingScriptLoad,0x88E7C480,0x7B7A,0x47C5,0x83,0x29,0xCE,0x1F,0xDF,0x41,0x55,0x27);
