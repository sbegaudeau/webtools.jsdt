...
//		TESTS_RANGE = new int[] { 169, 180 };
	...
	public void test002() {
		...
		String actualOutput = null;
		try {
			byte[] classFileBytes = org.eclipse.wst.jsdt.internal.compiler.util.Util.getFileByteContent(new File(OUTPUT_DIR + File.separator  + "X$1MyLocal$A$Member$1.class"));
			actualOutput =
				disassembler.disassemble(
					classFileBytes,
					"\n",
	...
	public void test003() {
		...
		String actualOutput = null;
		try {
			byte[] classFileBytes = org.eclipse.wst.jsdt.internal.compiler.util.Util.getFileByteContent(new File(OUTPUT_DIR + File.separator  + "X$1LocalClass.class"));
			actualOutput =
				disassembler.disassemble(
					classFileBytes,
					"\n",
